...
import styles, { keyStyle as ks, BG_COLOR } from './styles'
...
class Keyboard extends Component {
  ...
  _overridedKeyStyle() {
    return StyleSheet.create(
      this.props.overrideKeyStyle ? { ...ks, ...(this.props.overrideKeyStyle(ks) || {}) } : ks,
    )
  }

  _getUnderlayColor() {
    return this.props.keyUnderlayColor || BG_COLOR
  }
  ...
  _renderOtherText(key) {
    const keyStyle = this._overridedKeyStyle()
